...
(function() {
    ...
    progress.util._convertToABLWhereString = function(tableRef, filter) {
        var result = [], logic = filter.logic || "and", idx, length, field, type, format, operator, value, ablType, filters = filter.filters, whereOperators = {
            eq: "=",
            neq: "<>",
            gt: ">",
            gte: ">=",
        ...
        for (idx = 0,
        length = filters.length; idx < length; idx = idx + 1) {
            filter = filters[idx];
            field = filter.field;
            value = filter.value;
            if (filter.filters) {
    ...
    progress.util._formatDate = function(date, format) {
        var dateFormatRegExp = /dddd|ddd|dd|d|MMMM|MMM|MM|M|yyyy|yy|HH|H|hh|h|mm|m|fff|ff|f|tt|ss|s|zzz|"[^"]*"|'[^']*'/g;
...
(function() {
    ...
    progress.data.JSTableRef = function JSTableRef(jsdo, tableName) {
        ...
        this._loadBeforeImageData = function(jsonObject, beforeImageJsonIndex, keyFields) {
            var prodsBeforeData = jsonObject[this._jsdo._dataSetName]["prods:before"], tmpIndex = {}, record, record2, recordId, key, tmpKeyIndex, id, jsrecord, tmpDataIndex, tmpDeletedIndex, i;
    ...
    progress.data.JSDO = function JSDO(resNameOrParmObj, serviceName) {
        ...
        this._mergeUpdateForCUD = function(jsonObject, xhr) {
            var hasError = false, errorString;
            if (this._dataSetName) {
    ...
    progress.data.PluginManager.addPlugin("JFP", {
        requestMapping: function(jsdo, params, info) {
            var sortFields, field, ablFilter, properties, capabilities, reqCapabilities = "ablFilter,top,skip,id,orderBy";
...
(function() {
    ...
    progress.data.Session = function Session() {
        ...
        var restApplicationIsOnline = false;
        ...
        this.login = function(serviceURI, loginUserName, loginPassword, loginTarget) {
            var uname, pw, isAsync = false, args = [], deferred, jsdosession;
            pwSave = null;
            unameSave = null;
        ...
        this.logout = function() {
            var isAsync = false, errorObject = null, xhr, deferred, jsdosession;
            if (this.loginResult !== progress.data.Session.LOGIN_SUCCESS && this.authenticationModel) {
        ...
        this.addCatalog = function() {
            var catalogURI, catalogUserName, catalogPassword, isAsync = false, xhr, deferred, jsdosession, catalogIndex;
            if (arguments.length > 0) {
                if (typeof (arguments[0]) === "object") {
    ...
    progress.data.JSDOSession = function JSDOSession(options) {
        ...
        this.login = function(username, password) {
            var deferred = $.Deferred(), loginResult, errorObject;
            try {
        ...
        this.addCatalog = function(catalogURI, username, password) {
            var deferred = $.Deferred(), catalogURIs, numCatalogs, catalogIndex, addResult, errorObject;
            if (typeof catalogURI == "string") {
...
(function() {
    ...
    JSDOTransport = kendo.data.RemoteTransport.extend({
        ...
        _initConvertTypes: function() {
            var transport = this, i, schema, fieldName, array = [];
        ...
        _convertDataTypes: function(data) {
            var transport = this, k, fieldName, array, ablType;
        ...
        _getModel: function() {
            var transport = this, i, fields = {}, schema, value, type;
            schema = transport.jsdo[transport.tableRef].getSchema();
            for (i = 0; i < schema.length; i += 1) {
        ...
        _getInitialValues: function() {
            var transport = this, i, data = {}, schema;
            schema = transport.jsdo[transport.tableRef].getSchema();
            for (i = 0; i < schema.length; i += 1) {
                if (schema[i].name.length > 0 && schema[i].name.charAt(0) !== "_") {
        ...
        _getData: function(options) {
            var jsdo = this.jsdo, data = {}, params, array, filter;
        ...
        read: function(options) {
            try {
                var jsdo = this.jsdo, filter, data = {}, transport = this, callback;
                ...
                callback = function onAfterFillJSDO(jsdo, success, request) {
                    if (success) {
                        ...
                        if (options.data && options.data.take) {
                            if (!this.readLocal && transport.countFnName !== undefined && typeof (jsdo[transport.countFnName]) === "function") {
        ...
        _processChanges: function(options) {
            var jsdo = this.jsdo, transport = this, array, i, jsrecord;
            if (options.batch) {
                array = [];
        ...
        create: function(options) {
            var jsdo = this.jsdo, jsrecord, saveUseRelationships = jsdo.useRelationships;
        ...
        submit: function(options) {
            var jsdo = this.jsdo, i, jsrecord, saveUseRelationships = jsdo.useRelationships;
